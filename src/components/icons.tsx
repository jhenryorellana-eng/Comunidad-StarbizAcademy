...
const paths: Record<string, string> = {
  ...
  store: "M6 8h12l-1.2 13H7.2L6 8zM9 8V6a3 3 0 016 0v2",
  fileText: "M6 3h9l5 5v13H6zM14 3v6h6M9 13h7M9 17h7",
  shieldCheck: "M12 3l8 3v6c0 4.6-3.2 7.8-8 9-4.8-1.2-8-4.4-8-9V6l8-3zM9 12l2.2 2.2L15.5 10",
  flag: "M5 21V4M5 5h11l-1.5 3.5L18 12H5",
  play: "M8 5l11 7-11 7V5",
  star: "M12 3l2.3 5.6 6 .5-4.6 4 1.4 5.9L12 15.8 6.9 19l1.4-5.9-4.6-4 6-.5L12 3z",
